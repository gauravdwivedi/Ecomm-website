...
class App extends Component {
	...
	render() {
		...
		let noheaderUrl = ['/login', '/signup', '/cart', '/account', '/product', '/confirm', '/order', '/forgetpassword', '/reset-password/:token', '/checkout', '/favourites', '/address', '/add-address', '/checkout/order-placed']

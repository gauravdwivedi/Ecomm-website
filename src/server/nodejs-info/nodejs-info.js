...
<main>
    ...
    <table>
        ...
        <tr><td>Dev Dependencies</td><td>{{package.devDependencies}}</td></tr>
        {{/if}}
        <tr><td colspan="2"><h2>Scripts</h2></td></tr>
        <tr><td colspan="2">
            <table>
...
function nodeinfo(req, options) {
    ...
    if (context.package && context.package.devDependencies) { // convert devDependencies to list
        context.package.devDependencies = Object.keys(context.package.devDependencies).join(', ');
    }
